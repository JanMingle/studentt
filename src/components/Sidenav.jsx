...
export default function Sidenav() {
  ...
  const navigationItems = [
    ...
    { text: 'My Bursaries', icon: <ApplyIcon />, path: '/my-bursaries' },
    { text: 'Apply for Bursary', icon: <ApplyIcon />, path: '/apply' },
    { text: 'Bursary Resources', icon: <ResourceIcon />, path: '/resources' },
